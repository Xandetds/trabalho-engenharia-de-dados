...
O dashboard é uma aplicação **Streamlit** que consome as tabelas da camada Gold
armazenadas no MinIO e apresenta um panorama dos dados eleitorais do TSE em uma
única página (*one page view*).
