...
O desenvolvimento acontece num ambiente containerizado com Jupyter Lab, onde os notebooks são criados e testados A orquestracao fica no Apache Airflow: cada tarefa da DAG executa um notebook com Papermill e salva uma copia executada como evidencia da etapa.
